...
const PROJECTS = [
  {
    ...
    title: "Yavuz Grup",
    category: {
      tr: "Web Sitesi, Marka Kimliği & Sosyal Medya",
      en: "Website, Brand Identity & Social Media",
    },
    description: {
      tr: "İnşaat, gayrimenkul, turizm, enerji ve sigorta alanlarında faaliyet gösteren Kocaeli merkezli grup için çok markalı kurumsal site — her şirket kendi mikrositesiyle. Marka kimliği ve iki hesabın içerik yönetimi de bizde.",
      en: "A multi-brand corporate site for a Kocaeli-based group working in construction, real estate, tourism, energy and insurance — each company with its own microsite. Brand identity and content for two social accounts as well.",
    },
    tags: ["Next.js", "Mikrosite", "SEO", "Sosyal Medya"],
